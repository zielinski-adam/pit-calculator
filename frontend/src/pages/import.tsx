...
export function ImportPage() {
  const { file, setFile, taxYear, setTaxYear, priorLosses, setPriorLosses, isCalculating, error, result } =
    useAppStore();
  ...
  const handleCalculate = () => {
    if (!file) return;
    calculate.mutate({ file, taxYear, priorLosses });
  };
          ...
          >
            ...
            {file ? (
              ...
              <>
                ...
                <p className="font-medium">Przeciągnij plik CSV lub kliknij</p>
                <p className="text-sm text-muted-foreground">
                  IBKR Activity Statement (format CSV)
                </p>
              </>
            )}
          </div>
